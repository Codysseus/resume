...
\section{Education}
\cventry{9/2019--6/2021(exp)}{Masters Computer Science}{Oregon State University}{Corvallis}{}{Research on improving SGX+ORAM performance and fuzzing Real Time Operating Systems.}
\cventry{9/2014--6/2018}{Undergraduate Computer Science}{Oregon State University}{Corvallis}{\textit{Undergrad GPA: \textbf{3.52}}}{Studied Computer Science with an interest in security and Linux systems.}  % arguments 3 to 6 can be left empty
%\cventry{year--year}{Degree}{Institution}{City}{\textit{Grade}}{Description}
\subsection{Relevant Coursework}
\cvitem{}{Networking, OSI\&II, Analysis of Algorithms, Cyber Attacks and Defense, Senior Design}

\section{Research Projects}
\subsection{\textbf{SGX + ORAM}}
We are building on existing works that use CircuitORAM within SGX Enclaves and improving performance to be usable as a web server.
\subsection{\textbf{Fuzzing + Symbolic Execution}}
We are doing research that combines Symbolic execution with Fuzzing to reduce time spent on simple failure conditions in functions and improve bug finding.
The research specifically focuses on fuzzing Real Time Operating Systems to ensure isolation between computer systems.
...
\cventry{4/2018--6/2018}{Oregon State University}{Teacher's Assistant for CS312 System Administration}{Corvallis}{}{Graded Student work and lead labs. Contributed to the quality of new coursework. }

\cventry{9/2015--6/2016}{Oregon State University}{Teacher's Assistant for CS161 \& CS162}{Corvallis}{}{Graded student work and helped students understand key Computer Science concepts.\newline{}The programming language for these courses is C++.}
