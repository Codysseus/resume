...
\extrainfo{Graduate Student Seeking Internship}                 % optional, remove / comment the line if not wanted
...
\section{Education}
\cventry{9/2019--6/2021(exp)}{M.S. Computer Science}{Oregon State University}{Corvallis, OR}{}{Research on improving SGX+ORAM performance to create an Oblivious Searchable Database and fuzzing Real Time Operating Systems.}
\cventry{9/2014--6/2018}{B.S. Computer Science}{Oregon State University}{Corvallis, OR}{\textit{cum laude (GPA: \textbf{3.52})}}{Studied Computer Science with an interest in security and Operating Systems.}  % arguments 3 to 6 can be left empty
%\cventry{year--year}{Degree}{Institution}{City}{\textit{Grade}}{Description}
\subsection{Relevant Coursework}
\cvitem{}{Systems Security, OSI\&II, Analysis of Algorithms, Cyber Attacks and Defense, Senior Design}
...
\cventry{9/2018--6/2019}{Oregon State University}{Faculty Research Assistant}{Remote}{}{Researching automated testing of Real Time Operating Systems using Open Source Fuzzing and Symbolic Execution software.}
\cventry{6/2016--6/2018}{OSU Open Source Lab}{Student Systems Engineer}{Corvallis, OR}{}{Gained knowledge of system administration tools and techniques by working with coworkers and mentors to solve problems for clients hosting on our servers. Projects ranged from building components of a testing pipeline to writing tools to migrate data from Open Source project management tools.}%

\cventry{1st and 4th year}{Oregon State University}{Teacher's Assistant for Intro Computer Science I \& II,  System Administration}{Corvallis, OR}{}{Graded student work and led labs. Helped students understand key Computer Science concepts in the Intro series. Guided students in performing System Administration tasks. Evaluated and provided feedback on new coursework. }

\section{Awards}
\cventry{Spring 2018}{1st Regionally, 4th Nationally}{Cyber Defense Competition}{Pacific Northwest National Labs}{}{Defended simulated ICS infrastructure from Attackers. Responsible for auditing existing Linux servers and configuring NTP.}
\cventry{Fall 2019}{1st Regionally, 4th Nationally}{Cyber Force Competition}{Pacific Northwest National Labs}{}{Defended a simulated High Performance Computing cluster from Attackers. Responsible for auditing, setting up Email stack, configuring NTP and DNS.}
